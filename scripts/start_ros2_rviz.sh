...
This launcher receives compressed color/depth and expands them only on the
workstation for RViz. Ctrl+C closes RViz and both local transport helpers.
EOF
}
...
echo "Point cloud:     /zed/zed_node/point_cloud/cloud_registered"
